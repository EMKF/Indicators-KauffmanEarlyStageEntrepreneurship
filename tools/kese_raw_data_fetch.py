...
def s3_update():
    files_lst = [
        'raw_data_fetch_time.pkl', 'cps_us.csv', 'cps_state.csv', 'pep_us.csv', 
        'pep_state.csv', 'bed_table1_us.csv', 'bed_table1_state.csv', 
        'bed_table7_us.csv', 'bed_table7_state.csv'
    ]
    ...
    for file in files_lst:
        file_to_s3(
            ...
            'emkf.data.research', 
            f'indicators/kese/raw_data/{file}'
        )
